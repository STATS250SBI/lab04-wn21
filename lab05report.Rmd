...
>**1.** Read the data into R. You'll need to give the name of this file (*in quotes!*) to `read.csv()`, and call the data.frame `coffee` (if you don't do this, you WILL get errors later). Be sure to set `stringsAsFactors = TRUE`! 
