...
In this Try It, we'll be using a data set we'll call `tuition` that contains information about cost of attendance for 1,861 colleges and universities around the United States.
